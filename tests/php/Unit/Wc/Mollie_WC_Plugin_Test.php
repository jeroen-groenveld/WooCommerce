...
class Mollie_WC_Plugin_Test extends TestCase
{
    ...
    /**
     * Test Apple Pay Gateway is not filtered because WooCommerce Session has stored value
     */
    public function testMaybeDisableApplePayGatewayDoesNotFilterBecauseWcSessionHasStoredValue()
    {
